...
public class FragmentActivityAdapter extends FragmentStatePagerAdapter {
    ...
    public FragmentActivityAdapter(ArrayList<BaseFragment> fragments, FragmentManager fm) {
        super(fm);
        if(fragments != null){
    ...
    public FragmentActivityAdapter(ArrayList<BaseFragment> fragments, FragmentManager fm, String[] titls) {
        super(fm);
        if(fragments != null){
            this.allFragment = fragments;
        }
