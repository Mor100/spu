...
import com.spu.dong.spu.activity.adapter.MyRecyclerMyFocusLeftAdapter;
...
public class MyQuestionLeftFragment extends BaseFragment {
    ...
    public void initView() {
        ...
        ArrayList<MyQuestion> data = arguments.getParcelableArrayList("data");
        rvMyFocus.setAdapter(new MyRecyclerMyFocusLeftAdapter(data,mActivity));
