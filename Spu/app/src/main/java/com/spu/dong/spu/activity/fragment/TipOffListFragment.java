...
import com.spu.dong.spu.activity.demo.MyRecyclerAdapter;
...
public class TipOffListFragment extends BaseFragment implements BGARefreshLayout.BGARefreshLayoutDelegate {
    ...
    private MyRecyclerTipOffAdapter myRecyclerAdapter;
...
////
    ...
    public void initView() {
        ...
        ArrayList<TipOffBeans> data = arguments.getParcelableArrayList("data");


        myRecyclerAdapter = new MyRecyclerTipOffAdapter(data, mActivity);
        //设置adapter
